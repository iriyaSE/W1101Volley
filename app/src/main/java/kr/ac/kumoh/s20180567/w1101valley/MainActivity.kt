package kr.ac.kumoh.s20180567.w1101valley
...
import kr.ac.kumoh.s20180567.w1101valley.databinding.ActivityMainBinding
...
//                        Toast.LENGTH_LONG).show()
                    binding.listMovies.adapter =
                        ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, movies)
                },
                {
                    Toast.makeText(application, it.toString(), Toast.LENGTH_LONG).show()
                }
